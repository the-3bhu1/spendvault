...
Balaji and leaves them guessing who sent it. First name only, so you appear the way everyone else
in the split does; a name that begins with an initial ("K S Tribhuvan") is kept whole instead, since
